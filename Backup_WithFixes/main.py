...
from summary_utils import save_run_summary, print_summary_report
...
def main():
    ...
    try:
        ...
        print(f"✅ 完整运行总结已保存到: {summary_path}")
    except Exception as e:
        print(f"⚠️  生成运行总结时出错: {e}")
